...
function App() {
  ...
  const addTodo = async (event) => {
    ...
    try {
      ...
      console.log("Response from Add Todo: ", res);
  ...
  const toggleTodo = async (id) => {
    try {
      ...
      console.log("Error while toggle: ", error);
    }
  };
                  ...
                  <div key={todo._id}>
                    {editingTodo === todo._id ? (
                      <div className="flex items-center gap-x-3">
                        <input
                          className="flex-1 p-3 border border-gray-200 rounded outline-none focus:ring-2 focus:ring-blue-300 text-gray-700 shawdow-inner"
                          type="text"
                          value={editedText}
